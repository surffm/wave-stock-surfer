...
const WaveStockSurfer = () => {
  ...
  { id: 'dolphin', name: 'Wave Dolphin', emoji: '🐬', unlocked: false, unlock: 'Reach 2 streak', color: '#3BA3FF', invertDirection: false },
  ...
  { id: 'wolf', name: 'Lone Wolf Rider', emoji: '🐺', unlocked: false, unlock: 'Get 2 power-ups', color: '#6E8B8E', invertDirection: false }
], []);
