...
const WaveStockSurfer = () => {
  ...
  { id: 'dolphin', name: 'Wave Dolphin', emoji: '🐬', unlocked: false, unlock: 'Reach 3 streak', color: '#3BA3FF', invertDirection: false },
  ...
  { id: 'wolf', name: 'Lone Wolf Rider', emoji: '🐺', unlocked: false, unlock: 'Reach 4 streak', color: '#6E8B8E', invertDirection: false }
], []);
