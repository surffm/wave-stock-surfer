...
const WaveStockSurfer = () => {
  ...
  { id: 'dolphin', name: 'Wave Dolphin', emoji: '🐬', unlocked: false, unlock: 'Score 100+', color: '#3BA3FF', invertDirection: false },
  ...
  { id: 'wolf', name: 'Lone Wolf Rider', emoji: '🐺', unlocked: false, unlock: 'Score 200+', color: '#6E8B8E', invertDirection: false }
], []);
