...
const WaveStockSurfer = () => {
  ...
  { id: 'gohan', name: 'Tide Master', emoji: '🐬', unlocked: false, unlock: 'Reach 5 streak', color: '#FFE66D', invertDirection: true },
  ...
  { id: 'dolphin', name: 'Wave Dolphin', emoji: '🧙‍♂️', unlocked: false, unlock: 'Get 3 power-ups', color: '#3BA3FF', invertDirection: false },
  ...
  { id: 'wolf', name: 'Lone Wolf Rider', emoji: '🦸‍♂️', unlocked: false, unlock: 'Get 3 power-ups', color: '#6E8B8E', invertDirection: false }
], []);
